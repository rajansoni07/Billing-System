<?php
  ...
  {
    echo "<script>location.href='../login/adminlogin.php'</script>";
  }
?>
<!DOCTYPE html>
<html>
  ...
  <nav class="navbar navbar-dark fixed-top bg-primary navbar-expand-sm">
    ...
    <div class="collapse navbar-collapse" id="nav-text">
      <span class="navbar-nav ml-auto p-4 navbar-text text-white h5">
        ...
        <div class="d-inline" id="sessionadmin"><?php echo $_SESSION['aemail']; ?></div>
      </span>
    </div>
  </nav>
...
<div class="container-fluid p-0" style="margin-top:90px">  <!-- start of container-fluid -->
  <div class="sidepanel" id="mymenu">
    ...
    <a href="#"><i class="mr-2 fas fa-tachometer-alt"></i><span>Dashboard</span></a>
    <a href="adminprofile.php"><i class="mr-2 fas fa-user"></i><span>Profile</span></a>
    <a href="manageproducts.php"><i class="mr-2 fas fa-table"></i><span>Manage Product</span></a>
    <a href="users.php"><i class="mr-2 fas fa-users"></i><span>Users</span></a>
