...
<div class="row">
  <div class="col-lg-6">
    <form action="" method="post" class="p-3">
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <label></label>
          <button class="btn btn-danger form-control mt-2" id="clearselect">Clear</button>
        </div>
      </div>
    </form>
  ...
  <div class="col-lg-6">
    ...
    <table class="table table-hover">
      ...
      <tfoot>
        <th scope="col" class="th-sm">Total Amount:</th>
        <th scope="col" class="th-sm" id="curbilltotal"></th>
        <th></th><th></th>
        <th class="text-right"><button class="btn btn-primary btn-block" id="createbill">Create Bill</button></th>
      </tfoot>
      <div id="msg"></div>
  </div>
</div>
